...
class FleetTrip(models.Model):
    ...
    acronym_department = fields.Integer(related='department_id.acronym',string='Tên viết tắt phòng ban')
    department_plan_id = fields.Many2one('hr.department', string="Đơn vị dự trù phương tiện")
    acronym_department_plan = fields.Integer(related='department_plan_id.acronym',string='Tên viết tắt phòng ban dự trù')
